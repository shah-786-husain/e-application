...
import ExchangeDonorForm from './ExchangeDonorForm';

function DonorRegisterForExchange() {
  return (
    <>
    ...
    <div className="collapse navbar-collapse " id="navbarNav">
      <ul className="navbar-nav ms-auto ">
       <li className="nav-item  ">
        ...
        <li className="nav-item   ">
          <Link className="nav-link active text-light" aria-current="page" to="/registerdonor">Donor Register</Link>
        </li>
        <li className="nav-item ">
          <Link className="nav-link active  text-warning" aria-current="page" to="/adminlogin">Logout</Link>
        </li>
...
export default DonorRegisterForExchange;